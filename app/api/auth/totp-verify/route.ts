...
export async function POST(request: NextRequest) {
    try {
        ...
        // Forward to Django VerifyTOTPView
        const djangoResponse = await fetch(`${DJANGO_API_URL}users/auth/totp/verify/`, {
            method: 'POST',
            headers: {
        ...
        // Copy Set-Cookie headers for JWT tokens
        ...
        console.error('TOTP verification proxy error:', error);
