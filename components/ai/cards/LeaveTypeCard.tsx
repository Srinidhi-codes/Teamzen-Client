...
export const LeaveTypeCard = ({ id, name, description, availability, onSelect }: LeaveTypeCardProps) => {
    ...
    return (
        <div className="bg-linear-to-br from-primary/10 via-card to-card border-b border-border/50 rounded-3xl p-6 space-y-4 animate-in zoom-in-95 duration-500 w-full group/leave">
            ...
            <button
                ...
                className="w-full py-4 rounded-2xl bg-primary text-primary-foreground hover:bg-primary/90 text-[10px] font-black uppercase tracking-widest transition-all duration-300 active:scale-95 flex items-center justify-center gap-2"
            >
                Initialize Request
            </button>
        </div>
